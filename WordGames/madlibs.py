#Importing the installed tkinter library
from tkinter import *

#Creating a display window
root = Tk() #initializing tkinter window
root.geometry('300x300') #setting width and height
root.title('Mad Libs Generator') #title of the window
Label(root, text= 'Mad Libs Generator \n Have Fun!' , 
    font = 'arial 20 bold').pack() 
    #root is the name which we give to our window 
    #text takes the text we want to display on the label 
    # #pack organizes the widgets
Label(root, text = 'Click Any One :', 
    font = 'arial 15 bold').place(x=40, y=80) 
    #place will place the widgets in specific positions

#Define functions for each story
def madlib1():
...
def madlib2():
    ...
    place+ ' with my bestfriend and '+person+ ' who was a '+adjactive1+ ' ' +insect +' .We ate some ' +food+
